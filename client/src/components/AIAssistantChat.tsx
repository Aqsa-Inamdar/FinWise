  ...
  const renderAssistantPayload = (payload?: AssistantResponse | null) => {
    ...
    return (
      <div className="mt-2 rounded border bg-background p-3 text-sm space-y-3">
        ...
        <details className="rounded-md border border-border/60 bg-muted/10 px-3 py-2" open>
          <summary className="cursor-pointer select-none font-medium">Explanation</summary>
          <div className="mt-3 space-y-4">
            ...
            {payload.evidence.length > 0 && (
              <div className="space-y-1 border-t border-border/60 pt-3">
                <p className="text-sm font-medium text-foreground">What data I used</p>
